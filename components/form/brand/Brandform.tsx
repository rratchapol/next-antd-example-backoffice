...
export default function BrandForm({ onSubmit }: UserFormProps) {
  ...
  return (
    <>
      ...
      >
        <Title level={4}>ข้อมูลแบรนด์</Title>
        ...
        <Row gutter={16}>
            <Col xs={24} md={5}>
                <Form.Item label="ชื่อแบรนด์" name="brandName" rules={[{ required: true, message: 'กรุณากรอกชื่อแบรนด์' }]}>
                  <Input />
                </Form.Item>
            </Col>
        </Row>
